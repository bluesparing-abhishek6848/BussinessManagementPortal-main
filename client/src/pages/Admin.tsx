...
import { AdminSidebar, makeSeoUrl } from "../Constant";
...
const Admin = () => {
  ...
  return (
    <>
       <Seo
        title="Admin Dashboard | Aapka Future"
        description="Admin control panel for managing users, branches, and finance."
        url= {makeSeoUrl("admin/dashboard")}
      />
